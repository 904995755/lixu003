...
import com.example.lixu04.bean.UserInfo;
import com.example.lixu04.database.UserDBHelper;
import com.example.lixu04.util.DateUtil;
import com.example.lixu04.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人用户", "公司用户","李旭 18990146"};
